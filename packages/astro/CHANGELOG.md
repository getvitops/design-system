...
- aad43b7: A gallery/lightbox that is a fully working modal lightbox with **zero JavaScript**, plus
...
- 7b391b3: Add `<wc-counter>` — animates a number from a start value to the value already in its fallback
...
- Updated dependencies [eb9ac79]
  ...
  - @getvitops/core@7.0.0
  - @getvitops/vite@7.0.0
