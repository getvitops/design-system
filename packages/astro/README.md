...
[`@getvitops/emdash`](../emdash/README.md#rendering-mode).
...
This is also what makes `vitops search notify` able to submit only what changed, rather than everything on
every deploy.
